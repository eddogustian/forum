...
class ThreadController extends Controller
{
	...
	{
		$allt=new Comment('search');
		$allt->unsetAttributes();
		$allt->thread_id=$id;
		if(isset($_POST['rating']))
		{
			$udah=Threadstar::model()->countByAttributes(
				array('user_id'=>Yii::app()->user->id,'thread_id'=>$id));
			if($udah==0)
			{
				$itu=new Threadstar;
				$itu->nilai=$_POST['rating'];
				$itu->user_id=Yii::app()->user->id;
				$itu->thread_id=$id;
				$itu->save();
			}
		}
